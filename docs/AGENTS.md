# AGENTS.md - AI Agent Instructions for the spdx.cr Documentation Site

This document is for AI agents editing the spdx.cr documentation site under `docs/`.

## Project Overview

This is the documentation companion to [spdx.cr](https://github.com/hahwul/spdx.cr), a Crystal implementation of the SPDX specification. The site is a static site built with [Hwaro](https://github.com/hahwul/hwaro) (Crinja/Jinja2 templates).
...
- Keep terminology consistent with the SPDX spec: "document", "package", "license expression", "relationship".
- Code samples must be valid Crystal that runs against the latest spdx.cr - copy from the repo's `examples/` directory when in doubt.
